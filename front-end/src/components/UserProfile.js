...
export default function UserProfile(props) {
	const { books, notes, questions, projects, github, linkedin, name } = props;
	return (
		<div
			style={{
				display: 'flex',
		...
		>
			<div
				...
				style={{ display: 'flex', marginRight: 'auto', marginLeft: '150px' }}
			>
				<Card style={{ width: '18rem', backgroundColor: '#d6ecc5' }}>
					<Card.Img
						style={{}}
						variant='top'
					...
					<Card.Body>
						...
						<Card.Text>2018331046</Card.Text>
						<div
							style={{
								display: 'flex',
								flexDirection: 'row',
